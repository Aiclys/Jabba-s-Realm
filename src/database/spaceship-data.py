...
def add_spaceships():
    ...
    cur.execute("INSERT INTO spaceships VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", (spaceship_id, name, path_to_img, category, manufacturer, price, length, width, height, crew, role, max_atmos_speed, hyperdrive, shielding, engine, turbolaser, torpedo, consumables))
    con.commit()
...
def get_random_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE manufacturer=?", (manufacturer, ))
...
def get_spaceships_by_name(name):
    if name == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE name=?", (name, ))
...
def get_spaceships_over_price(price):
    result = cur.execute("SELECT * FROM spaceships WHERE price>?", (price, ))
    res = result.fetchall()
    return res
...
def get_spaceships_in_category(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=?", (category, ))
...
def get_spaceships_over_length(length):
    result = cur.execute("SELECT * FROM spaceships WHERE length>?", (length, ))
    res = result.fetchall()
    return res
...
def get_spaceships_over_width(width):
    result = cur.execute("SELECT * FROM spaceships WHERE width>?", (width, ))
    res = result.fetchall()
    return res
...
def get_spaceships_over_height(height):
    result = cur.execute("SELECT * FROM spaceships WHERE height>?", (height))
    res = result.fetchall()
    return res
...
def get_spaceships_over_crewmembers(crewmembers):
    result = cur.execute("SELECT * FROM spaceships WHERE crew>?", (crewmembers, ))
    res = result.fetchall()
    return res
...
def get_spaceships_with_role(role):
    if role == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE role=?", (role, ))
...
def get_spaceships_over_speed(speed):
    result = cur.execute("SELECT * FROM spaceships WHERE max_atmos_speed>?", (speed, ))
    res = result.fetchall()
    return res
...
def get_spaceships_with_hyperdrive(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE hyperdrive=1 AND category=?", (category, ))
...
def get_spaceships_without_hyperdrive(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE hyperdrive=0 AND category=?", (category, ))
...
def get_spaceships_with_shielding(shielding):
    if shielding == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE shielding =?", (shielding, ))
...
def longest_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE length=MAX(length) AND category=?", (category, ))
...
def average_spaceship_length(category):
    if category == "all":
        ...
        result = cur.execute("SELECT AVG(length) FROM spaceships WHERE category=?", (category, ))
...
def shortest_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE length=MIN(length) AND category=?", (category, ))
...
def longest_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE length=MAX(length) AND manufacturer=?", (manufacturer, ))
...
def average_spaceship_length_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT AVG(length) FROM spaceships WHERE manufacturer=?", (manufacturer, ))
...
def shortest_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE length=MIN(length) AND manufacturer=?", (manufacturer, ))
...
def widest_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE width=MAX(width) AND category=?", (category, ))
...
def average_spaceship_width(category):
    if category == "all":
        ...
        result = cur.execute("SELECT AVG(width) FROM spaceships WHERE category=?", (category, ))
...
def least_wide_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE width=MIN(width) AND category=?", (category, ))
...
def widest_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE width=MAX(width) AND manufacturer=?", (manufacturer, ))
...
def average_spaceship_width_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT AVG(width) FROM spaceships WHERE manufacturer=?", (manufacturer, ))
...
def least_wide_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE width=MIN(width) AND manufacturer=?", (manufacturer, ))
...
def highest_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE height=MAX(height) AND category=?", (category, ))
...
def average_spaceship_height(category):
    if category == "all":
        ...
        result = cur.execute("SELECT AVG(height) FROM spaceships WHERE category=?", (category, ))
...
def lowest_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE height=MIN(height) AND category=?", (category, ))
...
def highest_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE height=MAX(height) AND manufacturer=?", (manufacturer, ))
...
def average_spaceship_height_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT AVG(height) FROM spaceships WHERE manufacturer=?", (manufacturer, ))
...
def lowest_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE height=MIN(height) AND manufacturer=?", (manufacturer, ))
...
def most_crewmembers_in_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE crew=MAX(crew) AND category=?", (category, ))
...
def average_crewmembers_in_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT AVG(crew) FROM spaceships WHERE category=?", (category, ))
...
def least_crewmembers_in_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE crew=MIN(crew) AND category=?", (category, ))
...
def most_crewmembers_in_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE crew=MAX(crew) AND manufacturer=?", (manufacturer, ))
...
def average_crewmembers_in_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT AVG(crew) FROM spaceships WHERE manufacturer=?", (manufacturer, ))
...
def least_crewmembers_in_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE crew=MIN(crew) AND manufacturer=?", (manufacturer, ))
...
def most_expensive_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MAX(price) AND category=?", (category, ))
...
def average_spaceship_price(category):
    if category == "all":
        ...
        result = cur.execute("SELECT AVG(price) FROM spaceships WHERE category=?", (category, ))
...
def cheapest_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MIN(price) AND category=?", (category, ))
...
def most_expensive_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MAX(price) AND manufacturer=?", (manufacturer, ))
...
def average_spaceship_price_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT AVG(price) FROM spaceships WHERE manufacturer=?", (manufacturer, ))
...
def cheapest_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MIN(price) AND manufacturer=?", (manufacturer, ))
...
def most_expensive_spaceship_with_hyperdrive(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MAX(price) AND category=? AND hyperdrive=1", (category, ))
...
def average_spaceship_price_with_hyperdrive(category):
    if category == "all":
        ...
        result = cur.execute("SELECT AVG(price) FROM spaceships WHERE category=? AND hyperdrive=1", (category, ))
...
def cheapest_spaceship_with_hyperdrive(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MIN(price) AND category=? AND hyperdrive=1", (category, ))
...
def most_expensive_spaceship_with_hyperdrive_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MAX(price) AND manufacturer=? AND hyperdrive=1", (manufacturer, ))
...
def average_spaceship_price_with_hyperdrive_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT AVG(price) FROM spaceships WHERE manufacturer=? AND hyperdrive=1", (manufacturer, ))
...
def cheapest_spaceship_with_hyperdrive_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MIN(price) AND manufacturer=? AND hyperdrive=1", (manufacturer, ))
...
def most_expensive_spaceship_without_hyperdrive(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MAX(price) AND category=? AND hyperdrive=0", (category, ))
...
def average_spaceship_price_without_hyperdrive(category):
    if category == "all":
        ...
        result = cur.execute("SELECT AVG(price) FROM spaceships WHERE category=? AND hyperdrive=0", (category, ))
...
def cheapest_spaceship_without_hyperdrive(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MIN(price) AND category=? AND hyperdrive=0", (category, ))
...
def most_expensive_spaceship_without_hyperdrive_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MAX(price) AND manufacturer=? AND hyperdrive=0", (manufacturer, ))
...
def average_spaceship_price_without_hyperdrive_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT AVG(price) FROM spaceships WHERE manufacturer=? AND hyperdrive=0", (manufacturer, ))
...
def cheapest_spaceship_without_hyperdrive_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE price=MIN(price) AND manufacturer=? AND hyperdrive=0", (manufacturer, ))
...
def fastest_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE max_atmos_speed=MAX(max_atmos_speed) AND category=?", (category, ))
...
def slowest_spaceship(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE max_atmos_speed=MIN(max_atmos_speed) AND category=?", (category, ))
...
def average_spaceship_speed(category):
    if category == "all":
        ...
        result = cur.execute("SELECT AVG(max_atmos_speed) FROM spaceships WHERE category=?", (category, ))
...
def fastest_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE max_atmos_speed=MAX(max_atmos_speed) AND manufacturer=?", (manufacturer, ))
...
def average_spaceship_speed_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT AVG(max_atmos_speed) FROM spaceships WHERE manufacturer=?", (manufacturer, ))
...
def slowest_spaceship_from_manufacturer(manufacturer):
    if manufacturer == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE max_atmos_speed=MIN(max_atmos_speed) AND manufacturer=?", (manufacturer, ))
...
def sort_spaceships_by_id_asc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY id ASC", (category, ))
...
def sort_spaceships_by_id_desc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY id DESC", (category, ))
...
def sort_spaceships_by_name_asc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY name ASC", (category, ))
...
def sort_spaceships_by_name_desc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY name DESC", (category, ))
...
def sort_spaceships_by_price_asc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY price ASC", (category, ))
...
def sort_spaceships_by_price_desc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY price DESC", (category, ))
...
def sort_spaceships_by_length_asc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY length ASC", (category, ))
...
def sort_spaceships_by_length_desc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY length DESC", (category, ))
...
def sort_spaceships_by_width_asc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY width ASC", (category, ))
...
def sort_spaceships_by_width_desc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY width DESC", (category, ))
...
def sort_spaceships_by_height_asc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY height ASC", (category, ))
...
def sort_spaceships_by_height_desc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY height DESC", (category, ))
...
def sort_spaceships_by_crew_asc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY crew ASC", (category, ))
...
def sort_spaceships_by_crew_desc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY crew DESC", (category, ))
...
def sort_spaceships_by_speed_asc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY max_atmos_speed ASC", (category, ))
...
def sort_spaceships_by_speed_desc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY max_atmos_speed DESC", (category, ))
...
def sort_spaceships_by_turbolaser_asc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY turbolaser ASC", (category, ))
...
def sort_spaceships_by_turbolaser_desc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY turbolaser DESC", (category, ))
...
def sort_spaceships_by_torpedo_asc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY torpedo ASC", (category, ))
...
def sort_spaceships_by_torpedo_desc(category):
    if category == "all":
        ...
        result = cur.execute("SELECT * FROM spaceships WHERE category=? ORDER BY torpedo DESC", (category, ))
