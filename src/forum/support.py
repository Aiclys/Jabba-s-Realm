...
def send():
    ...
    elif (user == "goodbye" or user == "see you later" or user == "bye"):
        txt.insert(END, "\n" + "Bot -> Have a nice day!")
...
lable1 = Label(root, bg=BG_COLOR, fg=TEXT_COLOR, text="Welcome", font=FONT_BOLD, pady=10, width=30, height=1).grid(
    row=0)
...
e = Entry(root, bg="#f6f6f6", fg="#000000", font=FONT, width=55)
